...
//    ================semi manual=================
    public void SimpanFilmstatement(String kode, String judul, String genre, String tahun, String asal, String stok){
        try {
            String SQLSimpan = "INSERT INTO film(kodefilm,judul,genre,tahun,asal,stok) VALUES('"+kode+"','"+judul+"','"+genre+"','"+tahun+"','"+asal+"','"+stok+"')";
    ...
    public void SimpanFilmPrepared(String kode, String judul, String genre, int tahun, String asal, int stok){
        try {
